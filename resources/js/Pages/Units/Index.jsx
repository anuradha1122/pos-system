...
export default function Index({ auth, units }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Units</h2>}
        >
            <Head title="Units" />
            ...
            <div className="py-6">
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center justify-between rounded-xl bg-white p-6 shadow">
                        <div>
                            <h3 className="text-lg font-semibold text-gray-900">Unit List</h3>
                            <p className="text-sm text-gray-500">Manage product units</p>
                        </div>
