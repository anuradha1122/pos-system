...
export default function Show({ auth, statement }) {
    const { supplier, transactions, summary, filters } = statement;
    ...
    const applyFilters = (e) => {
        ...
        router.get(
            route('supplier-statements.show', supplier.id),
            { from, to },
            {
                preserveState: true,
                preserveScroll: true,
    ...
    const resetFilters = () => {
        router.get(route('supplier-statements.show', supplier.id));
    };
            ...
            <div className="p-6">
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <a
                            href={route('supplier-statements.pdf', {
                ...
                <div className="mb-6 grid gap-4 md:grid-cols-3">
                    ...
                    <div className="rounded bg-white p-5 shadow">
                        <p className="text-sm text-gray-500">Paid / Returned</p>
                        <p className="mt-1 text-2xl font-bold text-green-700">
                            {money(summary.total_paid_or_returned)}
                        </p>
                    </div>

                    <div className="rounded bg-white p-5 shadow">
                        <p className="text-sm text-gray-500">Outstanding Payable</p>
                        <p
